...
function CoursesCard({course, onDelete, onEdit}) {
    ...
    async function confirmDelete(id) {
        Alert.alert(
            'Confirmação',
            'Realmente deseja excluir esse curso?',
            [
                {text: 'Sim', onPress: () => deleteCourse(id)},
    ...
    return(
        <>
            {showEdit ? 
                (
                    <>
                        <FormCourse onSubmit={editCourse} course={course}/>
                ...
                (
                    <View style={styles.card}>
                        <ScrollView>
                            ...
                            <Text style={
                                (course.status === 'Inativo') ? (styles.red) : (styles.dataText)}
                            >{course.status}</Text>
                        </ScrollView>
                        {(course.status === 'Ativo') && (
                            <View style={styles.buttonsGroup}>
                                ...
                                <TouchableOpacity style={styles.row} onPress={() => confirmDelete(course.id)}>
