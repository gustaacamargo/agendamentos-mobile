...
function PlacesCard({place, onDelete, onEdit}) {
    ...
    return(
        <>
            {showEdit ? 
                (
                    <>
                        <FormPlace onSubmit={editPlace} place={place}/>
                ...
                (
                    <View style={styles.card}>
                        <ScrollView>
                            ...
                            <Text style={styles.dataText} >{place.name}</Text>

                            <Text style={styles.titleText}>Capacidade</Text>
                            <Text style={styles.dataText} >{place.capacity}</Text>

                            <Text style={styles.titleText}>Status</Text>
                            <Text style={
                                (place.status === 'Inativo') ? (styles.red) : (styles.dataText)}
                            >{place.status}</Text>
                        </ScrollView>
                        {(place.status === 'Ativo') && (
                            <View style={styles.buttonsGroup}>
                                ...
                                <TouchableOpacity style={styles.row} onPress={() => confirmDelete(place.id)}>
